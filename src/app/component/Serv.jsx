    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {updates.map((item, index) => (
          <div
            key={item.id}
            className={`group relative bg-[#111] rounded-3xl overflow-hidden border border-white/10
            hover:border-red-500 hover:shadow-[0_0_25px_rgba(255,0,0,0.25)]
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-6">
              ...
              <p
                className="text-gray-200 text-sm opacity-0 max-h-0 overflow-hidden
                group-hover:opacity-100 group-hover:max-h-40 group-hover:mt-2 transition-all duration-500"
              >
                {item.description}
              </p>
            </div>
